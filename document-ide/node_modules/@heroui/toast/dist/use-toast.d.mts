...
declare function useToast<T extends ToastProps>(originalProps: UseToastProps<T>): {
    ...
    closeIcon: ReactNode | ((props: DOMAttributes<HTMLElement>) => ReactNode);
    classNames: SlotsToClasses<"base" | "wrapper" | "title" | "description" | "icon" | "loadingComponent" | "content" | "progressTrack" | "progressIndicator" | "motionDiv" | "closeButton" | "closeIcon"> | undefined;
    color: any;
    hideIcon: boolean;
    placement: ToastPlacement;
    state: ToastState<T>;
